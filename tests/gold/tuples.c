...
void tuples(int32_t v0, int32_t * out)
{
  ...
  int32_t v13;
  int32_t v14;
  struct s_15_signedS32_signedS32_signedS32_signedS32_signedS32_signedS32_signedS32_signedS32_signedS32_signedS32_signedS32_signedS32_signedS32_signedS32_signedS32 e15 = { .member1 = 0, .member2 = 0, .member3 = 0, .member4 = 0, .member5 = 0, .member6 = 0, .member7 = 0, .member8 = 0, .member9 = 0, .member10 = 0, .member11 = 0, .member12 = 0, .member13 = 0, .member14 = 0, .member15 = 0 };
  
  (v1).member1 = v0;
  (v1).member2 = (v0 * 3);
  (v2).member1 = (v0 + (v1).member2);
  (v2).member2 = ((v1).member2 + v0);
  ...
  (e15).member13 = v13;
  (e15).member14 = v14;
  (e15).member15 = ((v6).member7 * (v6).member1);
  *out = ((((((((((((((v8 + v9) + v10) + v11) + v12) + v13) + v14) + v8) + v9) + v10) + v11) + v12) + v13) + v14) + (e15).member15);
}
