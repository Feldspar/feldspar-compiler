...
void metrics(struct s_arr_unsignedS32_UD_arr_signedS32_UD * v0, struct s_arr_unsignedS32_UD_arr_signedS32_UD * v1, struct s_arr_unsignedS32_UD_arr_s_arr_unsignedS32_UD_arr_s_unsignedS32_unsignedS32_UD_UD * v2, struct s_arr_unsignedS32_1_arr_s_arr_unsignedS32_1_arr_signedS32_UD_UD * out)
{
  ...
  uint32_t v67;
  uint32_t len1;
  struct s_arr_unsignedS32_UD_arr_signedS32_UD st2 = { .member1 = NULL, .member2 = NULL };
  struct s_arr_unsignedS32_UD_arr_signedS32_UD * v15 = NULL;
  uint32_t v68;
  ...
  v15 = &st2;
  v71 = initArray(v71, sizeof(struct s_arr_unsignedS32_UD_arr_signedS32_UD), len1);
  for (uint32_t v14 = 0; v14 < len1; v14 += 1)
  {
    ...
    (at(struct s_arr_unsignedS32_UD_arr_signedS32_UD,v71,v14)).member1 = setLength((at(struct s_arr_unsignedS32_UD_arr_signedS32_UD,v71,v14)).member1, sizeof(uint32_t), 1);
    at(uint32_t,(at(struct s_arr_unsignedS32_UD_arr_signedS32_UD,v71,v14)).member1,0) = v68;
    (at(struct s_arr_unsignedS32_UD_arr_signedS32_UD,v71,v14)).member2 = initArray((at(struct s_arr_unsignedS32_UD_arr_signedS32_UD,v71,v14)).member2, sizeof(int32_t), v68);
    for (uint32_t v18 = 0; v18 < v68; v18 += 1)
    {
      at(int32_t,(at(struct s_arr_unsignedS32_UD_arr_signedS32_UD,v71,v14)).member2,v18) = at(int32_t,(*v15).member2,(at(struct s_unsignedS32_unsignedS32,(v69).member2,v18)).member1);
    }
    v15 = &at(struct s_arr_unsignedS32_UD_arr_signedS32_UD,v71,v14);
  }
